...
<head>
    ...
    <title>Crear Nuevo Aire Acondicionado</title>
    <style>
...
<body>
    <div class="container">
        <h1>Crear Nuevo Aire Acondicionado</h1>
        ...
        <form action="{{ route('aires.store') }}" method="POST">
            ...
            <button type="submit">Guardar Aire Acondicionado</button>
        </form>
        <a href="{{ route('aires.index') }}" class="back-link">Volver al Listado</a>
    </div>
</body>
</html>