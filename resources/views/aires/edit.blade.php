    ...
    <div class="container">
        ...
        <form action="{{ route('aires.update', $aire->id) }}" method="POST">
            ...
            <div>
                ...
                <input type="text" id="marca" name="marca" value="{{ old('marca', $aire->marca) }}" required>
                @error('marca')
            ...
            <div>
                ...
                <input type="text" id="modelo" name="modelo" value="{{ old('modelo', $aire->modelo) }}" required>
                @error('modelo')
                    <div class="error-message">{{ $message }}</div>
                @enderror
            </div>
            <div>
                ...
                <input type="text" id="estado" name="estado" value="{{ old('estado', $aire->estado) }}" required>
                @error('estado')
                    <div class="error-message">{{ $message }}</div>
                @enderror
            </div>
            ...
            <button type="submit">Actualizar Aire Acondicionado</button>
        </form>
