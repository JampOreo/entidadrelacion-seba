    ...
    <div class="container">
        ...
        <form action="{{ route('horarios.store') }}" method="POST">
            ...
            <div>
                ...
                <input type="text" id="dia_semana" name="dia_semana" value="{{ old('dia_semana') }}" required>
                @error('dia_semana')
            ...
            <div>
                ...
                <input type="text" id="tipo_horario" name="tipo_horario" value="{{ old('tipo_horario') }}">
                @error('tipo_horario')
                    <div class="error-message">{{ $message }}</div>
                @enderror
            </div>
            <div>
                ...
                <input type="text" id="estado" name="estado" value="{{ old('estado', 'Activo') }}" required>
                @error('estado')
                    <div class="error-message">{{ $message }}</div>
                @enderror
            </div>
