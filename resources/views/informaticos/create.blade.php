...
<head>
    ...
    <title>Inscribir a un Nuevo Informático</title>
    <style>
...
<body>
    <div class="container">
        ...
        <form action="{{ route('informaticos.store') }}" method="POST">
            @csrf
            <div>
            ...
            <div>
                ...
                <input type="text" id="disponibilidad" name="disponibilidad" value="{{ old('disponibilidad') }}">
                @error('disponibilidad')
                    <div class="error-message">{{ $message }}</div>
                @enderror
            </div>
            <button type="submit">Guardar Informatíco</button>
        </form>
